...
-- Packages / Products (managed from admin panel)
CREATE TABLE packages (
  id          UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  name        TEXT NOT NULL,
  slug        TEXT UNIQUE NOT NULL,
  category    TEXT NOT NULL DEFAULT 'general',
  -- categories: pbn | contextual | edu | profile | niche-edit | boost
  description TEXT,
  price_usd   INTEGER NOT NULL,  -- in cents
  links_count TEXT,              -- e.g. "30 links" or "100–200 links"
  dr_range    TEXT,              -- e.g. "DA 40+" or "DR 50–70"
  features    JSONB DEFAULT '[]',
  badge       TEXT,              -- 'popular' | 'best_value' | null
...
-- Packages: anyone can read active ones
